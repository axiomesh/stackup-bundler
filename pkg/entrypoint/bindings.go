...
// HandleAggregatedOps is a paid mutator transaction binding the contract method 0x8084e44f.
//
// Solidity: function handleAggregatedOps(((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)[],address,bytes,bytes,bytes)[] opsPerAggregator, address beneficiary) returns()
